...
| §14.2 Buildings | P | Spaceport + Orbital Tracking Station exist. Spaceport tier I/II/III in-place upgrade lifecycle live (`upgradeSpaceport` consumes the §14.2 cost table and bumps `placed.tier` in place; UI affordance in the orbital modal). T6 Antenna's satellite-dish dual role N. |
